...
if (isset($_POST['submit'])) {
    ...
    $uploadDir = 'C:/xamppphp74/htdocs/pertemuan-6/upload/';
    ...
    if (move_uploaded_file($tempImage, $uploadPath)) {
        // Save to database
        $query = "INSERT INTO products (name, price, image) VALUES ('$name', '$price', '/pertemuan-6 perubahan/upload/$randomFilename')";
